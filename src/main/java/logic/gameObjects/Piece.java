...
public class Piece implements Serializable {
    ...
    public Piece(Cell pos, PieceColor color, Mode playMode) throws OccupiedCellException {
        this.color = color;
     ...
     *                                   posible
     */
    public void tryToMoveTo(Cell targetPosition)
        throws InvalidMoveException, OutOfBoundsException {
     ...
     *                                   posible
     */
    public void tryToMoveFast(Cell targetPosition)
        throws InvalidMoveException, OutOfBoundsException {
        //TODO todo
        if (targetPosition.equals(this.position)) { // Comprobamos que la posición que queremos alcanzar no es la de
            // partida
     ...
     * @return Devuelve si se puede llevar a cabo el movimiento
     */
    private boolean recursiveTryToMoveFast(
        Cell targetPosition,
        boolean[][] checkedCells,
        Queue<Cell> positionQueue
    ) {
