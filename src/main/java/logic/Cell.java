...
public class Cell {
	...
	public Cell getMiddleCellTowards(Cell other) throws CellsNotLinedUpException, InvalidOperationException {
	...
	@Override
	public boolean equals(Object other) { // Ahora se puede usar ==
